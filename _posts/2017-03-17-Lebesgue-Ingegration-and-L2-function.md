...
description: Lebesgue measure, Lebesgue ingegration, L2 functions 
...
$${\mu}^\circ ({\cal A}) = \inf_{ {\cal B}:{\cal B}\, covers \,{\cal A}} \mu ({\cal B})$$.  
...
$${\cal S} = \bigcup_{k=1}^\infty {\cal A}_k$$ and $${\cal D} = \bigcap_{k=1}^\infty {\cal A}_k$$ are measurable.  
